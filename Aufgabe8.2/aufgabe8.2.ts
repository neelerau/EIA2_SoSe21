...
namespace landscape {
    ...
    function startLandscape(_event: Event): void {
        ...
        for (var height: number = 400; height < 700; height += 2) {
    ...
    function drawFlowerRosa(_x: number, _y: number): void {
    ...
    //Funktion blau Blume
    function drawFlowerBlue(_x: number, _y: number): void {
        //Stiel
        crc2.beginPath();
    ...
    function drawFlowerPurpil(_x: number, _y: number): void {
